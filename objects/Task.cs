...
namespace ToDoList
{
  public class Task
  {
    ...
    public Task(string Description, DateTime dueDateTime, int Id = 0)
    {
      _id = Id;
    ...
    public void Save()
    {
      ...
      SqlCommand cmd = new SqlCommand("INSERT INTO tasks (description, due_date) OUTPUT INSERTED.id VALUES (@TaskDescription, @TaskDueDateTime);", conn);
